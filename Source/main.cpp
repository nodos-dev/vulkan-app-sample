...
void CreateTexturePinsInNodos()
{
	...
	constexpr nosExternalMemoryHandleType NOS_PLATFORM_EXTERNAL_MEMORY_HANDLE_TYPE =
#if defined(_WIN32)
		NOS_EXTERNAL_MEMORY_HANDLE_TYPE_WIN32;
#elif defined(__linux__)
		(nosExternalMemoryHandleType)1;
#else
#error "Unsupported platform"
	0;
#endif
	...
	flatbuffers::FlatBufferBuilder fbb;
	{
		...
		Ext.mutate_handle_type(NOS_PLATFORM_EXTERNAL_MEMORY_HANDLE_TYPE);
